...
// data.forEach(stuff => console.log(stuff.address.city));

// create an array of latitude and longitude coordinate pairs:
const newArray = [];
function cord(thing) {
  newArray.push(thing.address.geo);
}
data.forEach(thing2 => cord(thing2));
console.log(newArray);

// create an array of strings that combine the company's catchPhrase and bs
// const newArray2 = [];
// data.forEach(thing3 => newArray2.push(thing3.company.catchPhrase + thing3.company.bs);

// console.log(newArray2); //This is not quite right need {} somewhere
